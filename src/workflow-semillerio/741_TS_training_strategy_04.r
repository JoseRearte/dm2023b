...
PARAM  <- list()
PARAM$experimento <- "TS7410_04"

PARAM$exp_input  <- "FE7310_04"
...
PARAM$train$training     <- c( 202103, 202102, 202101, 202012, 202011, 202010, 202009, 202008, 202006, 202004, 202002, 202001, 201912, 201911, 201910, 201909, 201908, 201907)
...
PARAM$train$semilla  <- 287629  # cambiar por su propia semilla  !!!
